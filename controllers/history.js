...
const getSingleHistory = async (req, res) => {
  //GetSingleHistory
  historyAuthenticated(req, res, async () => {
    // Obtiene el historial médico individual
...
const updateNewinformation = async (req, res) => {
  historyAuthenticated(req, res, async () => {
    // this update new medical information
    const userId = new ObjectId(req.params.id);
    const contact = {
      firstName: req.body.firstName,
      lastName: req.body.lastName,
...
const deleteNewinformation = async (req, res) => {
  historyAuthenticated(req, res, async () => {
    // This delete all medical information 
    const userId = new ObjectId(req.params.id);
